            ...
            <div className="flex flex-col space-y-6">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a
                    href="mailto:contact@techvision.ai"
              ...
              <div className="border-t pt-6">
                <p className="text-sm text-gray-600 max-w-3xl">
                  TechVision AI empowers businesses with cutting-edge artificial intelligence solutions that transform raw data into actionable insights. Our platform combines advanced machine learning algorithms with intuitive analytics tools to help companies make data-driven decisions and stay ahead of market trends.
                </p>
              </div>
            </div>
